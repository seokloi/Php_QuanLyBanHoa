  ...
  <tr bgcolor="#F4FBEB">
      ...
      <tr>
        <td bgcolor="#C7EAB0"><span class="style3">&nbsp;<span class="style11">Danh mục
          ...
          <table width="100%" border="0" bgcolor="#F4FBEB">
            <tr>
              <td class="style7">&nbsp;<a href="trang_1.php">Trang ch&#7911;</a></td>
            </tr>
            <tr>
              <td class="style7">&nbsp;<a href="trang_2.php">T&igrave;m ki&#7871;m b&oacute; hoa </a></td>
            </tr>
            <tr>
              <td class="style7">&nbsp;<a href="trang_3.php">Th&ecirc;m m&#7899;i b&oacute; hoa </a></td>
            </tr>
          </table>		  </td>
      </tr>
      <tr>
    ...
    <td colspan="3" valign="middle" bgcolor="#F4FBEB"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>
		<?php
		echo '<p style="color:#006633"><b> Bạn <u>'.$_SESSION["ten_dn"].'</u> đã đăng xuất!';
		echo '<br>Hẹn gặp lại lần sau.</b>';
		session_unset();
		?>
        </td>
      </tr>
